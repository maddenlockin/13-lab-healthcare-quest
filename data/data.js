const heart = {
    ...
    choices: [{
        ...
        result: 'Turns out you live in a food desert and there is no fresh produce within 3 miles of your home. You try taking the bus to the closest grocery store with fresh vegetables, but it takes 5 hours round trip and you miss out on seeing your kids on your only day off of work in 17 days. This is not sustainable and you give up on the lifestyle changes. You lose $25 and 35% health.',
        cash: -25,
        health: -35,
    }, {
        id: 'pay',
        description: 'You will skrimp in order to pay out of pocket to see the specialist',
        result: 'The cardiology specialist is the best doctor you have ever been to. She listens to you and gets you on the correct medication to manage your heart disease at its exact stage. You are definitely in the right hands medically. But your bill from your first visit is $250 plus the cost of biweekly labs, and she wants you to come back once a month. In order to help you afford treatment, the specialist decides to decrease how often you come in, but that decreases the effectiveness and you still only have enough money to eat one meal and one snack a day. You lose $600 and 15% health.',
        cash: -600,
        health: -15,
    }, {
        id: 'find',
        description: 'You decide to find another cardiologist that is in-network instead',
        result: 'It took 4 months to get an appointment with the in-network specialist after you finally confirmed that they take your insurance. The first visit is 15 minutes long and the doctor does not listen to your experience or answer your questions, instead looking at your chart from your PCP, handing you a prescription, ordering labs, and telling you to come back in 3 months. Your labs are covered by insurance but you have no idea what they are checking. When you return in 3 months, the doctor is unexpectedly on vacation and you have to reschedule for 2 months later. You do not lose any cash, but you lose 25% health.',
        cash: 0,
        health: -25,
    }]
};
...
const bill = {
    ...
    choices: [{
        ...
        result: 'Turns out your $160 bill has been sent to a debt collector and extra fees are racking up daily, so you cannot go back to the US unless you are going to pay thousands of dollars. You do not get to go back to see your family and apparently, they all hate Canada. So you never get to see your family again and must build a new life. You lose $100 and 10% health.',
        cash: -100,
        health: -10,
    }, {
        id: 'pay',
        description: 'No, it is not fair that you have this bill. But yeah, now you have this bill. You just pay it.',
        result: 'That sucked. You did not even get an answer about the super itchy rash on your inner elbow. But when you walk outside you immediately step on a five dollar bill. There is no one else around, so you keep it. Also, you have to take the bus to work for the next two weeks because you do not have enough gas money now. You lose $155 but do not lose any health.',
        cash: -155,
        health: 0,
    }]
};
